...
float getDepth(vec2 uv){
	return texture(depthTex, uv).r*1.7;
...
void main(void){
	...
	float d1 = getDepth(texCoords + kernel[1]  * sampleRadius*0.5);
	float d2 = getDepth(texCoords + kernel[2]  * sampleRadius*0.5);
	float d3 = getDepth(texCoords + kernel[3]  * sampleRadius*0.5);
	float d4 = getDepth(texCoords + kernel[4]  * sampleRadius*0.5);
	float d5 = getDepth(texCoords + kernel[5]  * sampleRadius*0.5);
